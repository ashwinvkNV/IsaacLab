...
def load_implicit_actuator_cfg(yaml_file: str, joint_names_expr: list[str]):
    ...
    return ImplicitActuatorCfg(
        ...
        effort_limit_sim=_filter_param(params.get("effort_limit_sim"), joint_names_expr),
        velocity_limit_sim=_filter_param(params.get("velocity_limit_sim"), joint_names_expr),
