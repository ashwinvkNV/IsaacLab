...
class set_robot_to_grasp_pose(ManagerTermBase):
    ...
    def __init__(self, cfg: EventTermCfg, env: ManagerBasedEnv):
        ...
        print(f"end_effector_body_name : {self.end_effector_body_name}")
        print(f"eef_idx : {self.eef_idx}")
    ...
    def __call__(
        ...
        for i in range(max_iterations):
            ...
            # joint_pos_limits is a warp array, convert to torch before indexing with env_ids
